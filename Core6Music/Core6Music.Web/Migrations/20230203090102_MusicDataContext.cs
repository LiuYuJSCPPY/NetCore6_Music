...
{
    public partial class MusicDataContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicManifestSong", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MusicManifestSong_MusicManifest_MusicManifestId",
                        column: x => x.MusicManifestId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicManifestSong_MusicManifestId",
                schema: "dbo",
                table: "MusicManifestSong",
                column: "MusicManifestId");
